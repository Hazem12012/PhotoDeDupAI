            ...
            <div className="bg-white/5 backdrop-blur-lg border-b border-white/10">
                <div className="max-w-7xl mx-auto px-8 py-6">
                    ...
                    <p className="text-gray-300 mb-6">
                        Advanced image management with AI-powered duplicate detection and face recognition
                    </p>
                    ...
                    <div className="flex gap-4">
                        <button
                            ...
                            className={`flex items-center gap-2 px-6 py-3 rounded-lg font-semibold transition-all duration-200 ${activeTab === 'duplicates'
                        ...
                        <button
                            ...
                            className={`flex items-center gap-2 px-6 py-3 rounded-lg font-semibold transition-all duration-200 ${activeTab === 'faces'
                                    ? 'bg-gradient-to-r from-purple-500 to-pink-500 text-white shadow-lg'
                                    : 'bg-white/5 text-gray-300 hover:bg-white/10'
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`flex items-center gap-2 px-6 py-3 rounded-lg font-semibold transition-all duration-200 ${activeTab === 'organize'
                                    ? 'bg-gradient-to-r from-purple-500 to-pink-500 text-white shadow-lg'
                                    : 'bg-white/5 text-gray-300 hover:bg-white/10'
                                }`}
                        >
