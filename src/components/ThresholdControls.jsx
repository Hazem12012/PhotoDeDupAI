...
const ThresholdControls = ({ ssimThreshold, mseThreshold, onSsimChange, onMseChange, disabled }) => {
    const presets = [
    ...
    return (
        <div className="bg-white/5 backdrop-blur-lg rounded-xl p-6 border border-white/10">
            <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-white font-semibold text-lg">Similarity Thresholds</h3>
            </div>
